...
| [Tasks](./tasks/) | _unreleased — requires Silo 0.59+, see its README_ | Silo-managed task lists — a global personal list and one per workspace, in a side panel; no external tracker, nothing written into a repo |
