...
| [System Monitor](./system-monitor/) | [![latest](https://img.shields.io/github/v/release/silo-code/silo-extensions?filter=system-monitor*&label=)](https://github.com/silo-code/silo-extensions/releases?q=system-monitor) | Live CPU, memory, and per-terminal process monitoring in a side panel and status bar |
...
| [Tasks](./tasks/) | _unreleased — needs a published SDK carrying RFC 0032, see its README_ | Silo-managed task lists — a global personal list and one per workspace, in a side panel; no external tracker, nothing written into a repo |
