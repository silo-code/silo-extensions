...
import type { PrCommitDetail, PrCommitFileChange } from "../github-pr-api";
...
function statFor(f: PrCommitFileChange): ReactNode {
...
export function PrCommitView({ ctx, owner, repo, cwd, detail, loading, error }: PrCommitViewProps) {
  ...
  function openDiff(file: PrCommitFileChange) {
